...
A Graph database. Uses Cypher as a graph query language.

### Functional Requirement
- ACID Transactions
- Cypher Graph Query Language
- Full Text Indexing and Search
- Import / Loading data from other sources
- Native Graph Processing & Storage
- Graph size limit 34 billion Nodes (for open-source edition)
...
Steps extracted from the Browser (aka Movie Graph Guide).
...
### TODO
- [ ] Create a Neo4j cluster
- [ ] Add System Design
- [ ] Stats example in QPS, data in production
- [ ] Add a service that connects to the database
- [ ] Examples for Graph visualization tools https://neo4j.com/docs/getting-started/graph-visualization/graph-visualization-tools/
- [ ] Data Science examples https://neo4j.com/docs/getting-started/gds/
